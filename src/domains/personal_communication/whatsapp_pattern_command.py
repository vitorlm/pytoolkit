...
from domains.personal_communication.whatsapp_pattern_service import WhatsAppPatternService, WhatsAppMessage
...
File format: WhatsApp chat export (.txt format)
    ...
    def get_arguments(parser: ArgumentParser):
        ...
        # Additional options
        parser.add_argument("--regex", action="store_true", help="Treat pattern as regex (use with --pattern)")
        ...
        parser.add_argument("--include-content", action="store_true", help="Include full message content in output")
    ...
    def main(args: Namespace):
        ...
        try:
            ...
            if args.domain:
                ...
                results = {"domain_statistics": domain_stats, "total_domains": len(domain_stats)}
