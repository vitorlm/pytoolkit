...
class FeatureExtractor:
    ...
    def __init__(self):
        ...
        self.stop_words = {
            'COM', 'SEM', 'E', 'OU', 'DO', 'DA', 'DE', 'NO', 'NA', 'EM',
            'PARA', 'POR', 'ATE', 'ATÉ', 'TIPO', 'MARCA', 'TAMANHO'
        }
        
        # Words that indicate product variants/attributes
        self.variant_indicators = {
            # Flavors
            'SABOR', 'SABORES', 'CHOCOLATE', 'BAUNILHA', 'MORANGO', 'UVA',
            'LARANJA', 'LIMAO', 'LIMÃO', 'MENTA', 'NATURAL',
            
            # Types/Styles
            'LIGHT', 'DIET', 'ZERO', 'INTEGRAL', 'NORMAL', 'TRADICIONAL',
            'ESPECIAL', 'PREMIUM', 'CLASSICO', 'CLÁSSICO',
            
            # Colors/Visual
            'BRANCO', 'PRETO', 'AZUL', 'VERDE', 'VERMELHO', 'AMARELO',
            'DOURADO', 'CLARO', 'ESCURO',
            
            # Textures/Consistency
            'CREMOSO', 'LIQUIDO', 'LÍQUIDO', 'SOLIDO', 'SÓLIDO', 'POWDER',
            'CRISTAL', 'GRANULADO', 'FINO', 'GROSSO'
        }
        
        # Core product indicators (brand-independent)
        self.core_indicators = {
            # Main products
            'ARROZ', 'FEIJAO', 'FEIJÃO', 'AÇUCAR', 'ACUCAR', 'SAL', 'CAFE', 'CAFÉ',
            'LEITE', 'OVO', 'OVOS', 'FARINHA', 'MACARRAO', 'MACARRÃO', 'MASSA',
            'REFRIGERANTE', 'SUCO', 'AGUA', 'ÁGUA', 'CERVEJA',
            'BANANA', 'MACA', 'MAÇÃ', 'LARANJA', 'UVA', 'LIMAO', 'LIMÃO',
            'CARNE', 'FRANGO', 'PEIXE', 'PORCO', 'LINGUIÇA', 'LINGUICA',
            'PAO', 'PÃO', 'BISCOITO', 'BOLO', 'TORRADA',
            'QUEIJO', 'IOGURTE', 'MANTEIGA', 'MARGARINA',
            'OLEO', 'ÓLEO', 'VINAGRE', 'MOLHO', 'TEMPERO', 'CONDIMENTO',
            'SABAO', 'SABÃO', 'DETERGENTE', 'AMACIANTE', 'DESINFETANTE'
        }
    ...
    def find_potential_duplicates(self, features_list: List[ProductFeatures]) -> List[Tuple[ProductFeatures, ProductFeatures, float]]:
        """
    ...
    def _calculate_core_similarity(self, features1: ProductFeatures, features2: ProductFeatures) -> float:
        ...
        core_similarity = self._jaccard_similarity(
            set(features1.core_key.split()),
            set(features2.core_key.split())
        )
