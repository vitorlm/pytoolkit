...
class GenericProductManager:
    ...
    def __init__(
        ...
        try:
            ...
            self.logger.info(
                f"Similarity detection initialized (SBERT: {use_sbert}, threshold: {similarity_threshold})"
            )
    ...
    def find_or_create_generic_product(
        self,
        description: str,
            ...
            if best_match and best_score >= self.similarity_calculator.similarity_threshold:
                ...
                return {
                    "result": self._create_match_result_from_similarity(
                        best_match["product"], best_match["similarity_result"]
                    )
                }
    ...
    def _create_new_generic_product(
        self,
        description: str,
        establishment_id: str,
    ...
    def update_generic_product_statistics(
        self,
        generic_product_id: str,
        establishment_id: str,
        unit_price: Decimal | None,
    ...
    def create_or_update_establishment_product(
        self,
        generic_product_id: str,
        establishment_id: str,
