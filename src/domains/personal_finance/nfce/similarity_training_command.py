...
try:
    ...
    ADVANCED_IMPORT_ERROR = None
except ImportError as e:
    ADVANCED_AVAILABLE = False
    ADVANCED_IMPORT_ERROR = e
    ...
    def main(args: Namespace):
        ...
        try:
            ...
            if args.mode == "collect":
                ...
                handler.train_model(model_type=args.model_type, detailed=args.detailed)
...
class SimilarityTrainingHandler:
    ...
    def active_learning_suggestions(
        ...
        uncertain_pairs = self.trainer.suggest_training_examples(
            candidate_pairs=candidate_pairs, n_suggestions=suggestions
        )
        ...
        if detailed and self.trainer.current_model is not None:
            ...
            if test_pairs:
                ...
                for i, (prod1, prod2, feat1, feat2, orig_score) in enumerate(
                    ...
                    print(f"     {prod2[:40]}...")
                    print(
                        f"     Original: {orig_score:.3f} | ML: {confidence:.3f} ({'Similar' if is_similar else 'Different'})"
                    )
                    print()
            ...
            while True:
                ...
                if response in ["y", "yes"]:
                    ...
                    self.trainer.add_training_example(
                        product1=prod1,
                        product2=prod2,
                        product1_features=feat1,
                        product2_features=feat2,
                        user_says_similar=True,
                        confidence=confidence,
                    )
                    print("✅ Marked as SIMILAR")
