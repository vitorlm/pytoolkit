...
from domains.personal_finance.nfce.advanced_product_deduplication_service import AdvancedProductDeduplicationService
  ...
  python src/main.py personal_finance nfce product-deduplication --input step2_similarity.json --export-csv --export-excel
    ...
    def get_arguments(parser: ArgumentParser):
        ...
        parser.add_argument(
            "--export-csv",
            action="store_true",
            help="Export clean table to CSV format"
        )
