    ...
    def _dict_to_invoice_data(self, invoice_dict: Dict[str, Any]) -> InvoiceData:
        ...
        try:
            ...
            invoice_data = InvoiceData(
                ...
                products_amount=Decimal(str(invoice_dict["products_amount"]))
                if invoice_dict.get("products_amount")
                else None,
            ...
            for i, invoice_dict in enumerate(invoices):
                try:
                    ...
                    if result:
                        ...
                        self.logger.warning(
                            f"Invoice {i + 1} with access_key {invoice_data.access_key[-10:]}... was skipped (likely duplicate)"
                        )
