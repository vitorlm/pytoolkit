  ...
  2. Get your token from: https://app.circleci.com/settings/user/tokens
    ...
    def main(args):
        ...
        try:
            ...
            if not args.project_slug:
                logger.error("❌ Project slug is required for analysis. Use --project-slug or --list-projects to see available projects")
                exit(1)
    ...
    def _print_complete_results(result) -> None:
        ...
        for i, bottleneck in enumerate(bottlenecks, 1):
            print(f"   {i}. {bottleneck['job']}: {bottleneck['avg_duration_minutes']}m "
        ...
        print(f"   Target pipeline time: {plan['estimated_final_time']}s "
