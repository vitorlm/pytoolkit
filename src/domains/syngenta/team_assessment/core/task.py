...
class TaskSummary(Task):
    ...
    planned_task_days: int | None = None
    executed_task_days: int | None = None
    planned_resources: int | None = None
    actual_resources: int | None = None
    ...
    def duration_deviation_percentage(self) -> float:
        ...
        """
        if self.planned_task_days and self.planned_task_days > 0:
            return ((self.executed_task_days - self.planned_task_days) / self.planned_task_days) * 100
        return 0.0
    ...
    def efficiency(self, duration_weight: float = 0.5, resource_weight: float = 0.5) -> float:
        ...
        combined_efficiency = (duration_efficiency * duration_weight) + (resource_efficiency * resource_weight)
