...
class WorkflowConfigService:
    ...
    def __init__(self, cache_expiration: int = 240):
        ...
        self.logger.info(f"WorkflowConfigService initialized with {len(self._project_mappings.get('project_mappings', {}))} project mappings")
    ...
    def _load_project_mappings(self) -> dict:
        ...
        try:
            ...
            return JSONManager.read_json(self._mappings_file, default={
                "project_mappings": {},
    ...
    def validate_workflow_config(self, project_key: str) -> dict[str, list[str]]:
        ...
        try:
            ...
            self.logger.info(f"Validation completed for {project_key}: {len(validation_results['errors'])} errors, {len(validation_results['warnings'])} warnings")
